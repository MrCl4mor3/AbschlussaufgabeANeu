...
/**
 * Formats output for merge actions.
 *
 * @author ucgdi
 */
public final class MergeOutputFormatter {
    ...
    /**
     * Formats the output of a merge action.
     *
     * @param success whether the merge was successful
     * @param existingUnit the unit already on the target field
     * @param movedUnit the moved or placed unit
     * @param targetPosition the target field
